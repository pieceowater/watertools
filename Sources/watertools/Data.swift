...
public let MyApps: [Ad] = [
    Ad(id: 1,
       ...
       icon: "MoneyGuardApp.png",
       previews: ["moneyguard1EN.jpg","moneyguard2EN.jpg","moneyguard3EN.jpg","moneyguard4EN.jpg"],
    ...
    Ad(id: 2,
       ...
       icon: "SpeedStoryApp.png",
       previews: ["speedstory1EN.jpg","speedstory2EN.jpg","speedstory3EN.jpg"],
